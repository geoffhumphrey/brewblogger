...
<tr <?php echo " style=\"background-color:$color\"";?>>
   ...
   <td class="data-icon_list"><a href="index.php?action=view&dbTable=mash_steps&id=<?php echo $row_mash_profiles['id']; ?>"><img src="<?php echo $imageSrc; ?>monitor.png" align="absmiddle" border="0" alt="View <?php echo $row_mash_profiles['mashProfileName']; ?>" title="View <?php echo $row_mash_profiles['mashProfileName']; ?>"></a></td>
