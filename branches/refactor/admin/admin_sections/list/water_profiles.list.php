...
<tr <?php echo " style=\"background-color:$color\"";?>>
   ...
   <td class="data-icon_list"><a href="index.php?action=edit&dbTable=water_profiles&id=<?php echo $row_water_profiles['id']; ?>"><img src="<?php echo $imageSrc; ?>pencil.png" align="absmiddle" border="0" alt="Edit <?php echo $row_water_profiles['waterName']; ?>" title="Edit <?php echo $row_water_profiles['waterName']; ?>"></a></td>
