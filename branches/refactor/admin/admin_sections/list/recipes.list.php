...
<table class="dataTable">
 ...
 <tr <?php echo " style=\"background-color:$color\"";?>>
  ...
  <?php } if ($row_user['userLevel'] == "1") { ?>
  <td class="data-icon_list"><input id="brewFeatured" name="brewFeatured<?php echo $row_log['id']; ?>" type="checkbox" value="Y" <?php if ($row_log['brewFeatured'] == "Y") echo "checked"; else ""; ?> /></td>
  <?php } ?>
  <td class="data-icon_list"><input id="brewArchive" name="brewArchive<?php echo $row_log['id']; ?>" type="checkbox" value="Y" <?php if ($row_log['brewArchive'] == "Y") echo "checked"; else ""; ?> /></td>
  <td class="data-icon_list"><a href="../index.php?page=recipeDetail&id=<?php echo $row_log['id']; if ($row_pref['mode'] == "2") echo "&filter=".$row_log['brewBrewerID'];  ?>"><img src="<?php echo $imageSrc; ?>monitor.png" align="absmiddle" border="0" alt="View <?php echo $row_log['brewName']; ?>" title="View <?php echo $row_log['brewName']; ?>"></a></td>
  <td class="data-icon_list"><a href="index.php?action=reuse&dbTable=recipes&id=<?php echo $row_log['id']; ?>"><img src="<?php echo $imageSrc; ?>page_refresh.png" align="absmiddle" border="0" alt="Copy <?php echo $row_log['brewName']; ?>" title="Copy <?php echo $row_log['brewName']; ?>"></a></td>
