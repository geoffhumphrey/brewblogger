...
<table>
  <tr>
    <td class="data-icon"><img src="<?php echo $imageSrc; ?>tick.png" align="absmiddle"></td>
  ...
  <tr>
    <td class="data-icon"><img src="<?php echo $imageSrc; ?>newspaper.png" align="absmiddle"></td>
...
<table>
  <tr>
    <td class="data-icon" width="1%"><img src="<?php echo $imageSrc; ?>book.png" align="absmiddle"></td>
    ...
    <td class="data-icon" width="1%"><img src="<?php echo $imageSrc; ?>book_add.png"></td>
    <td class="data" width="33%"><a href="index.php?action=add&dbTable=brewing">Add <?php echo $row_pref['menuBrewBlogs']; ?></a></td>
    <td class="data-icon" width="1%"><img src="<?php echo $imageSrc; ?>picture_add.png" /></td>
  ...
  <tr>
    <td class="data-icon"><img src="<?php echo $imageSrc; ?>hourglass.png" align="absmiddle"></td>
    ...
    <td class="data-icon"><img src="<?php echo $imageSrc; ?>hourglass_add.png"></td>
    <td class="data"><a href="index.php?action=add&dbTable=upcoming">Add Upcoming <?php echo $row_pref['menuBrewBlogs']; ?></a></td>
    <td class="data-icon" width="1%"><?php if ($phpVersion >= "5") { ?><img src="<?php echo $imageSrc; ?>page_white_code.png" /><?php } else echo "&nbsp;"; ?></td>
  ...
  <tr>
    <td class="data-icon"><img src="<?php echo $imageSrc; ?>medal_gold_1.png" align="absmiddle" /></td>
    ...
    <td class="data-icon"><img src="<?php echo $imageSrc; ?>medal_gold_add.png" align="absmiddle" /></td>
    <td class="data"><a href="index.php?action=add&dbTable=awards&assoc=brewing">Add <?php echo $row_pref['menuAwards']; ?></a></td>
    <td class="data-icon"><img src="<?php echo $imageSrc; ?>calculator.png" /></td>
    <td class="data"><a href="index.php?action=calculate">Recipe Calculator</a></td>
  </tr>
  <tr>
    <td class="data-icon"><img src="<?php echo $imageSrc; ?>page_white_edit.png" align="absmiddle" /></td>
    ...
    <td class="data-icon"><img src="<?php echo $imageSrc; ?>page_white_add.png" align="absmiddle" /></td>
...
<table>
  <tr>
    <td class="data-icon" width="1%"><img src="<?php echo $imageSrc; ?>script.png"></td>
    ...
    <td class="data-icon" width="1%"><img src="<?php echo $imageSrc; ?>script_add.png"></td>
    ...
    <td class="data-icon" width="1%"><img src="<?php echo $imageSrc; ?>page_refresh.png" /></td>
...
<table>
  ...
  <tr>
    <td class="data-icon" width="1%"><img src="<?php echo $imageSrc; ?>link.png"></td>
    <td class="data" width="33%"><a href="index.php?action=list&dbTable=brewerlinks">Manage Links</a></td>
    <td class="data-icon" width="1%"><img src="<?php echo $imageSrc; ?>link_add.png"></td>
    <td class="data" width="33%"><a href="index.php?action=add&dbTable=brewerlinks">Add Links</a></td>
    <td class="data-icon" width="1%"><img src="<?php echo $imageSrc; ?>cog.png" /></td>
  ...
  <tr>
    ...
    <td class="data-icon"><img src="<?php echo $imageSrc; ?>user_add.png" /></td>
    <td class="data"><a href="index.php?action=add&dbTable=users">Add Users</a></td>
    <td class="data-icon">&nbsp;</td>
    <td class="data">&nbsp;</td>
  </tr>
  <tr>
    <td class="data-icon"><img src="<?php echo $imageSrc; ?>application.png"></td>
    <td class="data"><a href="index.php?action=list&dbTable=brewingcss">Manage Themes</a></td>
    <td class="data-icon"><img src="<?php echo $imageSrc; ?>application_add.png"></td>
  ...
  <tr>
    <td class="data-icon"><img src="<?php echo $imageSrc; ?>newspaper.png" /></td>
    <td class="data"><a href="index.php?action=list&dbTable=news">Manage News</a></td>
    <td class="data-icon"><img src="<?php echo $imageSrc; ?>newspaper_add.png" /></td>
...
<table>
  <tr>
    <td class="data-icon" width="1%"><img src="<?php echo $imageSrc; ?>user.png"></td>
    ...
    <td class="data-icon" width="1%"><img src="<?php echo $imageSrc; ?>key.png"></td>
...
<table>
  <tr>
    ...
    <td class="data-icon" width="1%"><img src="<?php echo $imageSrc; ?>note.png" /></td>
  ...
  <tr>
    ...
    <td class="data-icon"><img src="<?php echo $imageSrc; ?>database_add.png"></td>
    <td class="data"><a href="index.php?action=add&dbTable=extract">Add Extracts</a></td>
    <td class="data-icon"><img src="<?php echo $imageSrc; ?>group.png" /></td>
...
<table>
  <tr>
    <td class="data-icon" width="1%"><img src="<?php echo $imageSrc; ?>calculator.png"></td>
