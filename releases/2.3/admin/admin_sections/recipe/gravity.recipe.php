...
<tr>
   ...
   <td class="dataLabel" width="5%"><?php if ($dbTable != "recipes") echo "Target OG:"; else echo "&nbsp;"; ?></td>
   <td class="data"><?php if ($dbTable != "recipes") { ?><input name="brewTargetOG" type="text" size="10" tooltipText="<?php echo $toolTip_gravity; ?>" value="<?php if (($action == "importRecipe") || ($action == "edit") || (($action == "reuse") && ($dbTable == "recipes"))) echo $row_log['brewTargetOG']; if ($action == "importCalc") echo round ($brewTargetOG, 3); ?>"><?php } else echo "&nbsp;"; ?></td>
</tr>
...
<tr>
   ...
   <td class="dataLabel" width="5%"><?php if ($dbTable != "recipes") echo "Target FG:"; else echo "&nbsp;"; ?></td>
   <td class="data"><?php if ($dbTable != "recipes") { ?><input name="brewTargetFG" type="text" size="10" tooltipText="<?php echo $toolTip_gravity; ?>" value="<?php if (($action == "importRecipe") || ($action == "edit") || (($action == "reuse") && ($dbTable == "recipes"))) echo $row_log['brewTargetFG']; if ($action == "importCalc") echo round ($brewTargetFG, 3); ?>"><?php } else echo "&nbsp;"; ?></td>
</tr>
</table>