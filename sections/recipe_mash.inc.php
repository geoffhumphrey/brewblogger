...
<div class="row bcoem-account-info">
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
    	...
    	<div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"><?php echo $row_mash_profiles['mashGrainTemp']."&deg;".$row_pref['measTemp']; ; ?></div>
        </div>
        <?php } ?>
        <?php if (!empty($row_mash_profiles['mashTunTemp'])) { ?>
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"><strong>Ideal Tun Temp:</strong></div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"><?php echo $row_mash_profiles['mashTunTemp']."&deg;".$row_pref['measTemp']; ; ?></div>
        </div>
        <?php } ?>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
    	...
    	<div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"><?php echo $row_mash_profiles['mashSpargeTemp']."&deg;".$row_pref['measTemp']; ?></div>
        </div>
    	<?php } ?>
...
<?php if (($row_pref['mashDisplayMethod'] == "2") || (($row_pref['mashDisplayMethod'] == "1")  && ($row_log['brewMashProfile'] == ""))) { // unique mash profiles for every log
...
<div class="row bcoem-account-info">
	<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
    	...
    	<div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"><?php if ($action == "default") echo $row_log['brewMashGrainWeight']; if ($action == "scale") echo number_format(($row_log['brewMashGrainWeight'] * $scale), 2); echo "&nbsp;".$row_pref['measWeight2']; ?></div>
        </div>
        <?php } ?>
        ...
        <?php } ?>
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"><strong><?php if (($row_log['brewMashGravity'] != "" ) && ($row_log['brewPreBoilAmt'] != "") && ($row_log['brewGrain1'] != "")) { if ($row_pref['measFluid2'] == "liters") echo "PPK:"; else echo "PPG:"; } elseif ($row_log['brewPPG'] != "") { if ($row_pref['measFluid2'] == "liters") echo "PPK:"; else echo "PPG:"; } else echo ""; ?></strong></div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
    	...
    	<div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"><?php echo $row_log['brewMashGrainTemp']."&deg; ".$row_pref['measTemp']; ?></div>
        </div>
        <?php } ?>
        <?php if (!empty($row_log['brewMashSpargAmt'])) { ?>
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"><strong>Sparge Amount:</strong></div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"><?php if ($action == "default") echo $row_log['brewMashSpargAmt']; if ($action == "scale") echo number_format(($row_log['brewMashSpargAmt'] * $scale), 2); echo "&nbsp;".$row_pref['measFluid2']; ?></div>
        </div>
        <?php } ?>
        <?php if (!empty($row_log['brewMashSpargeTemp'])) { ?>
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"><strong>Sparge Temp:</strong></div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"><?php echo $row_log['brewMashSpargeTemp']."&deg; ".$row_pref['measTemp']; ?></div>
        </div>
        <?php } ?>
        <?php if (!empty($row_log['brewMashTunTemp'])) { ?>
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"><strong>Tun Temp:</strong></div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6"><?php echo $row_log['brewMashTunTemp']."&deg; ".$row_pref['measTemp']; ?></div>
        </div>
    	<?php } ?>
    </div><!-- /column 2 --> 
</div><!-- /row -->
...
<table class="table table-striped">
    ...
    <tbody>
        <tr>
            ...
            <td><?php echo $row_log['brewMashStep1Temp']."&deg; ".$row_pref['measTemp']; ?></td>
        ...
        <tr>
            ...
            <td><?php echo $row_log['brewMashStep2Temp']."&deg; ".$row_pref['measTemp']; ?></td>
        ...
        <tr>
            ...
            <td><?php echo $row_log['brewMashStep3Temp']."&deg; ".$row_pref['measTemp']; ?></td>
        ...
        <tr>
            ...
            <td><?php echo $row_log['brewMashStep4Temp']."&deg; ".$row_pref['measTemp']; ?></td>
        ...
        <tr>
            ...
            <td><?php echo $row_log['brewMashStep5Temp']."&deg; ".$row_pref['measTemp']; ?></td>
