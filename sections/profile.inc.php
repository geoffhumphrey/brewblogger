...
<tr>
	...
	<td class="data"><a href="index.php?page=brewblog-list&filter=<?php echo $filter; ?>&sort=brewDate&dir=DESC">View <?php echo $row_members['realFirstName']; ?>'s <?php echo $row_pref['menuBrewBlogs']; ?></a></td>
</tr>
<?php } ?>
<?php if ($totalRows_count2 > 0) { ?>
<tr>
	<td class="data-icon"><img src="<?php echo $imageSrc; ?>script.png"></td>
	<td class="data"><a href="index.php?page=recipe-list&filter=<?php echo $filter; ?>">View <?php echo $row_members['realFirstName']; ?>'s <?php echo $row_pref['menuRecipes']; ?></a></td>
</tr>
<?php } ?>
</table>
