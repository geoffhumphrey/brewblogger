...
<tr <?php echo " style=\"background-color:$color\"";?>>
    ...
    <td class="data-icon_list"><a href="../index.php?page=brewblog&id=<?php echo $row_review['brewID'] ?>#tasting"><img src="<?php echo $imageSrc; ?>monitor.png" align="absmiddle" border="0" alt="View the reviews for <?php echo $row_log_review['brewName'] ?>" title="View the reviews <?php echo $row_log_review['brewName'] ?>"></a></td>
