...
<table class="dataTable">
 ...
 <tr <?php echo " style=\"background-color:$color\"";?>>
  ...
  <td nowrap="nowrap" class="dataList" ><?php  $date = $row_awards['awardDate']; $realdate = dateconvert($date,3); echo $realdate; ?></td>
