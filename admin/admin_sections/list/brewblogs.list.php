...
<table class="dataTable">
    ...
    <tr <?php echo " style=\"background-color:$color\"";?>>
        ...
        <td class="data-icon_list"><a href="../index.php?page=brewblog&id=<?php echo $row_brewing['id']; if ($row_pref['mode'] == "2") echo "&filter=".$row_brewing['brewBrewerID'];  ?>"><img src="<?php echo $imageSrc; ?>monitor.png" align="absmiddle" border="0" alt="View <?php echo $row_brewing['brewName']; ?>" title="View <?php echo $row_brewing['brewName']; ?>"></a></td>
