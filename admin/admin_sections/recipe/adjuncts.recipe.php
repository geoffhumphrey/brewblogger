...
<tr>
   ...
   <?php } while ($row_adjuncts = mysqli_fetch_assoc($adjuncts)); $rows = mysqli_num_rows($adjuncts); if($rows > 0) {
mysqli_data_seek($adjuncts, 0); $row_adjuncts = mysqli_fetch_assoc($adjuncts); } ?>
   </select>
   </td>
