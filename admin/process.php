...
if (($action == "edit") && ($dbTable == "brewing")) {
  ...
  $updateSQL = sprintf("UPDATE brewing SET brewName=%s, brewStyle=%s, brewBatchNum=%s, brewCondition=%s, brewDate=%s, brewYield=%s, brewMethod=%s, brewCost=%s, brewLink1=%s, brewLink1Name=%s, brewLink2=%s, brewLink2Name=%s, brewInfo=%s, brewExtract1=%s, brewExtract1Weight=%s, brewExtract2=%s, brewExtract2Weight=%s, brewExtract3=%s, brewExtract3Weight=%s, brewExtract4=%s, brewExtract4Weight=%s, brewExtract5=%s, brewExtract5Weight=%s, brewGrain1=%s, brewGrain1Weight=%s, brewGrain2=%s, brewGrain2Weight=%s, brewGrain3=%s, brewGrain3Weight=%s, brewGrain4=%s, brewGrain4Weight=%s, brewGrain5=%s, brewGrain5Weight=%s, brewGrain6=%s, brewGrain6Weight=%s, brewGrain7=%s, brewGrain7Weight=%s, brewGrain8=%s, brewGrain8Weight=%s, brewGrain9=%s, brewGrain9Weight=%s, brewAddition1=%s, brewAddition1Amt=%s, brewAddition2=%s, brewAddition2Amt=%s, brewAddition3=%s, brewAddition3Amt=%s, brewAddition4=%s, brewAddition4Amt=%s, brewAddition5=%s, brewAddition5Amt=%s, brewAddition6=%s, brewAddition6Amt=%s, brewAddition7=%s, brewAddition7Amt=%s, brewAddition8=%s, brewAddition8Amt=%s, brewAddition9=%s, brewAddition9Amt=%s, brewMisc1Name=%s, brewMisc2Name=%s, brewMisc3Name=%s, brewMisc4Name=%s, brewMisc1Type=%s, brewMisc2Type=%s, brewMisc3Type=%s, brewMisc4Type=%s, brewMisc1Use=%s, brewMisc2Use=%s, brewMisc3Use=%s, brewMisc4Use=%s, brewMisc1Time=%s, brewMisc2Time=%s, brewMisc3Time=%s, brewMisc4Time=%s, brewMisc1Amount=%s, brewMisc2Amount=%s, brewMisc3Amount=%s, brewMisc4Amount=%s, brewHops1=%s, brewHops1Weight=%s, brewHops1IBU=%s, brewHops1Time=%s, brewHops2=%s, brewHops2Weight=%s, brewHops2IBU=%s, brewHops2Time=%s, brewHops3=%s, brewHops3Weight=%s, brewHops3IBU=%s, brewHops3Time=%s, brewHops4=%s, brewHops4Weight=%s, brewHops4IBU=%s, brewHops4Time=%s, brewHops5=%s, brewHops5Weight=%s, brewHops5IBU=%s, brewHops5Time=%s, brewHops6=%s, brewHops6Weight=%s, brewHops6IBU=%s, brewHops6Time=%s, brewHops7=%s, brewHops7Weight=%s, brewHops7IBU=%s, brewHops7Time=%s, brewHops8=%s, brewHops8Weight=%s, brewHops8IBU=%s, brewHops8Time=%s, brewHops9=%s, brewHops9Weight=%s, brewHops9IBU=%s, brewHops9Time=%s, brewHops1Use=%s, brewHops2Use=%s, brewHops3Use=%s, brewHops4Use=%s, brewHops5Use=%s, brewHops6Use=%s, brewHops7Use=%s, brewHops8Use=%s, brewHops9Use=%s, brewHops1Type=%s, brewHops2Type=%s, brewHops3Type=%s, brewHops4Type=%s, brewHops5Type=%s, brewHops6Type=%s, brewHops7Type=%s, brewHops8Type=%s, brewHops9Type=%s, brewHops1Form=%s, brewHops2Form=%s, brewHops3Form=%s, brewHops4Form=%s, brewHops5Form=%s, brewHops6Form=%s, brewHops7Form=%s, brewHops8Form=%s, brewHops9Form=%s, brewYeast=%s, brewYeastMan=%s, brewYeastForm=%s, brewYeastType=%s, brewYeastAmount=%s, brewLabelImage=%s, brewOG=%s, brewFG=%s, brewGravity1=%s, brewGravity1Days=%s, brewGravity2=%s, brewGravity2Days=%s, brewProcedure=%s, brewSpecialProcedure=%s, brewPrimary=%s, brewPrimaryTemp=%s, brewSecondary=%s, brewSecondaryTemp=%s, brewTertiary=%s, brewTertiaryTemp=%s, brewLager=%s, brewLagerTemp=%s, brewAge=%s, brewAgeTemp=%s, brewBitterness=%s, brewLovibond=%s, brewComments=%s, brewMashType=%s, brewMashGrainWeight=%s, brewMashGrainTemp=%s, brewMashTunTemp=%s, brewMashSpargAmt=%s, brewMashSpargeTemp=%s, brewMashEquipAdjust=%s, brewMashPH=%s, brewMashStep1Name=%s, brewMashStep1Desc=%s, brewMashStep1Temp=%s, brewMashStep1Time=%s, brewMashStep2Name=%s, brewMashStep2Desc=%s, brewMashStep2Temp=%s, brewMashStep2Time=%s, brewMashStep3Name=%s, brewMashStep3Desc=%s, brewMashStep3Temp=%s, brewMashStep3Time=%s, brewMashStep4Name=%s, brewMashStep4Desc=%s, brewMashStep4Temp=%s, brewMashStep4Time=%s, brewMashStep5Name=%s, brewMashStep5Desc=%s, brewMashStep5Temp=%s, brewMashStep5Time=%s, brewWaterName=%s, brewWaterAmount=%s, brewWaterCalcium=%s, brewWaterBicarb=%s, brewWaterSulfate=%s, brewWaterChloride=%s, brewWaterMagnesium=%s, brewWaterPH=%s, brewWaterNotes=%s, brewWaterSodium=%s, brewEfficiency=%s, brewPPG=%s, brewTapDate=%s, brewStatus=%s, brewMashGravity=%s, brewPreBoilAmt=%s, brewBrewerID=%s, brewTargetOG=%s, brewTargetFG=%s, brewMashProfile=%s, brewWaterProfile=%s, brewIBUFormula=%s, brewYeastProfile=%s, brewEquipProfile=%s, brewBoilTime=%s, brewFeatured=%s, brewWaterRatio=%s, brewArchive=%s WHERE id='%s'",
                       GetSQLValueString($_POST['brewName'], "scrubbed"),
                       GetSQLValueString($_POST['brewStyle'], "text"),
                       GetSQLValueString($_POST['brewBatchNum'], "text"),
                       GetSQLValueString($_POST['brewCondition'], "text"),
...
brewName=%s, brewStyle=%s, brewYield=%s, 
brewExtract1=%s, brewExtract1Weight=%s, 
brewExtract2=%s, brewExtract2Weight=%s, 
brewExtract3=%s, brewExtract3Weight=%s, 
brewExtract4=%s, brewExtract4Weight=%s, 
brewExtract5=%s, brewExtract5Weight=%s, 
brewGrain1=%s, brewGrain1Weight=%s, 
brewGrain2=%s, brewGrain2Weight=%s, 
brewGrain3=%s, brewGrain3Weight=%s, 
brewGrain4=%s, brewGrain4Weight=%s, 
brewGrain5=%s, brewGrain5Weight=%s, 
brewGrain6=%s, brewGrain6Weight=%s, 
brewGrain7=%s, brewGrain7Weight=%s, 
brewGrain8=%s, brewGrain8Weight=%s, 
brewGrain9=%s, brewGrain9Weight=%s, 
brewAddition1=%s, brewAddition1Amt=%s, 
brewAddition2=%s, brewAddition2Amt=%s, 
brewAddition3=%s, brewAddition3Amt=%s, 
brewAddition4=%s, brewAddition4Amt=%s, 
brewAddition5=%s, brewAddition5Amt=%s, 
brewAddition6=%s, brewAddition6Amt=%s, 
brewAddition7=%s, brewAddition7Amt=%s, 
brewAddition8=%s, brewAddition8Amt=%s, 
brewAddition9=%s, brewAddition9Amt=%s,
brewHops1=%s, brewHops1Weight=%s, brewHops1IBU=%s,brewHops1Time=%s, 
brewHops2=%s, brewHops2Weight=%s, brewHops2IBU=%s, brewHops2Time=%s, 
brewHops3=%s, brewHops3Weight=%s, brewHops3IBU=%s, brewHops3Time=%s, 
brewHops4=%s, brewHops4Weight=%s, brewHops4IBU=%s, brewHops4Time=%s, 
brewHops5=%s, brewHops5Weight=%s, brewHops5IBU=%s, brewHops5Time=%s, 
brewHops6=%s, brewHops6Weight=%s, brewHops6IBU=%s, brewHops6Time=%s, 
brewHops7=%s, brewHops7Weight=%s, brewHops7IBU=%s, brewHops7Time=%s, 
brewHops8=%s, brewHops8Weight=%s, brewHops8IBU=%s, brewHops8Time=%s, 
brewHops9=%s, brewHops9Weight=%s, brewHops9IBU=%s, brewHops9Time=%s,  
brewHops1Form=%s, brewHops2Form=%s, brewHops3Form=%s, brewHops4Form=%s, brewHops5Form=%s, 
brewHops6Form=%s, brewHops7Form=%s, brewHops8Form=%s, brewHops9Form=%s, 
brewOG=%s, 
brewFG=%s, 
brewBitterness=%s, 
brewLovibond=%s, 
